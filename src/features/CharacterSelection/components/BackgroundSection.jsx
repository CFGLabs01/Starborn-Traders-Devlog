...
const BackgroundSection = ({ shortBio, longBio, faction, origin, className = '' }) => {
  return (
    // Background Section - Apply passed className
    <div className={`bg-slate-800/95 p-4 rounded-2xl shadow-xl flex-grow ${className}`}>
      <h3 className="text-lg font-semibold text-teal-400 mb-2 font-display">Background</h3>
